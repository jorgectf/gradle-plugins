...
class ElasticBeanstalkPlugin implements Plugin < Project > {
    ...
    void apply(Project project) {
        ...
        def getCrossZoneLoadBalancingOption = {
            new ConfigurationOptionSetting()
            .withNamespace("aws:elb:loadbalancer")
            .withOptionName("CrossZone")
            .withValue("True")
        }
        ...
        def getOptionsSettings = {
            ...
            envOptions.add(getCrossZoneLoadBalancingOption())
            return envOptions
        }
        ...
        project.task([
            description: "deploys a new version to a new Elastic Beanstalk environment with zero downtime"
        ], 'deployBeanstalkZeroDowntime') << {
